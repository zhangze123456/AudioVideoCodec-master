...
import com.manna.codec.codec.ConvertTime;
...
public class MainActivity extends AppCompatActivity implements MediaMuxerChangeListener,
    ...
    private void initMediaCodec() {
        ...
        //
//        String filePath=FileUtils.getRoot()+ "/saveVideo"+fileName;
//        File file = new File(filePath);
//        if (!file.exists()) {
//            file.mkdirs();
//        }
//        String filePath = FileUtils.getRoot() + "/lawinforce/";
//        File file = new File(filePath);
//        if (!file.exists()) {
//            file.mkdirs();
//        }
    ...
    public void onMediaInfoListener(int time) {
        ...
        Log.d(TAG, "视频录制时长 --- " + ConvertTime.secToTime(time));
        runOnUiThread(new Runnable() {
            @Override
            public void run() {
                tvTime.setText(ConvertTime.secToTime(time));
            }
        });
